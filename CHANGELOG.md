...
### Added
- Linux (amd64) distribution build in release workflow
- Support for musl-gcc cross-compiler in build.sh

### Changed
- Release workflow now uses matrix strategy to build on both Ubuntu and macOS
- Artifacts are uploaded per-platform and merged for final release
